...
public abstract class Expression : StatementListItem, ISyntaxTreeRoot
{
    ...
    /// This property is automatically set by <see cref="AdhocAbstractSyntaxTree.ParseExpression(string, bool)"/> when <see cref="ParserOptions.Tokens"/> is set to <see langword="true"/>.
    /// </summary>
    /// <remarks>
    ...
    /// This property is automatically set by <see cref="AdhocAbstractSyntaxTree.ParseExpression(string, bool)"/> when <see cref="ParserOptions.Comments"/> is set to <see langword="true"/>.
    /// </summary>
    /// <remarks>
    /// The operation is not guaranteed to be thread-safe. In case concurrent access or update is possible, the necessary synchronization is caller's responsibility.
    /// </remarks>
